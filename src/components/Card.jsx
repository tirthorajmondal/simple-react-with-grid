...
const Card = ({ technology, handleAddToStack }) => {
    ...
    return (
        <div className='p-6 border rounded-4xl flex flex-col '>
            <div className='flex items-center justify-between '>

                <img src={technology.icon} alt="" className='h-12 w-12' />

                <button className="btn bg-emerald-100 px-3  py-1.5 text-blue-500 rounded-4xl">{technology.badge}</button>
            ...
            <div className='flex items-center justify-between font-bold my-12'>
            ...
            <div className=" mt-auto">
                <button
                    ...
                    className='w-full cursor-pointer bg-black p-5 rounded-4xl  text-white text-2xl '>Add to Stack</button>
            </div>
